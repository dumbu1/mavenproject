...
public class StepDefination {
	...
	public void user_check_the_list_box(DataTable testCaseData) {
		
		MyHooks obj_MyHooks=new MyHooks();
		wd=obj_MyHooks.getDriver();
		obj_SeleniumExamplePage=new SeleniumExamplePage(wd);
		List<String> expList=testCaseData.asList();
		List<String> actList=obj_SeleniumExamplePage.select_Options();
	...
	public void user_clicks_on_submit_button(String butName) throws InterruptedException {
